...
from server.main import app, check_json_header
...
@pytest.mark.parametrize(
    'headers',
    [{'user-agent': 'my-app/0.0.1'}, {'content-type': 'application/json'}, {}],
)
@pytest.mark.parametrize(
    'params', [{'tinkoff': 'academy'}, {'backend': 'top'}, {}]
)
...
@pytest.mark.parametrize('data', [{'key': 'rock'}, {'value': 'gas'}, {}])
...
@pytest.mark.parametrize('data', [{'dividend': '5'}, {'divider': '7'}, {}])
